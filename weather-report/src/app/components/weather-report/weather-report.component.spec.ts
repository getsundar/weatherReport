...
// import { LoadHourlyWeatherAction } from 'src/app/actions/hourly-weather.actions';
// fdescribe('WeatherReportComponent', () => {
...
//     //   })
//     // }));
//     // spyOn(weatherComponent, 'hourlyWeatherDetails$').and.returnValue( of ({
//     //   data: ({
//     //     timeStamp: 20,
//     //     avgTemp: 38,
//     //     windStrength: 39
